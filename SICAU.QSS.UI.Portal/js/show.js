...
/* WEBPACK VAR INJECTION */(function($) { __webpack_require__(6);
 ...
 show.showControler($('#page-container').attr('data-type'));
 $(document).ready(function(){
 	if($('#page-container').attr('data-type')!='wtQues' && $('#page-container').attr('data-type')!='wtVote'){
 		$('#submit').remove();
 		$('#cancel').html('返回');
 	}
 	...
 	if (($('#page-container').attr('data-type')).toString().indexOf('Vote')!=-1) {
 		$('.page-footer').remove();
 	}
 })
